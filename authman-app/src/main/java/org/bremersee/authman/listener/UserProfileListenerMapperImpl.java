...
public class UserProfileListenerMapperImpl implements UserProfileListenerMapper {
  ...
  @Override
  public UserProfileRegistrationRequestEventDto mapToRegistrationRequestEvent(
      @NotNull UserProfileCreateRequestDto request, @NotNull Date expirationDate) {

    final UserProfileRegistrationRequestEventDto dto = new UserProfileRegistrationRequestEventDto();
  ...
  @Override
  public UserProfileCreationEventDto mapToCreationEvent(@NotNull UserProfileDto userProfile,
      String password, @NotNull Collection<String> roles) {

    final UserProfileCreationEventDto dto = new UserProfileCreationEventDto();
  ...
  @Override
  public UserProfileChangeEventDto mapToChangeEvent(@NotNull UserProfileDto userProfile) {

    final UserProfileChangeEventDto dto = new UserProfileChangeEventDto();
