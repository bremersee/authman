...
import static org.bremersee.authman.samba.business.LdapEntryUtils.whenTimeToOffsetDateTime;
...
public class LdapEntryMapperImpl implements LdapEntryMapper {
  ...
  public SambaUser mapLdapEntryToSambaUser(@NotNull final LdapEntry ldapEntry) {
    ...
    final String pwdLastSet = LdapEntryUtils.getAttributeValue(ldapEntry, "last", null);
